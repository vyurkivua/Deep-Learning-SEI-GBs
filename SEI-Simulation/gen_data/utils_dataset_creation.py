...
def create_dataset(datagen_path, quantity, rotation, xyz_path, JSON_PATH, class_dict, surf_orientations):
    for i in range(0, quantity):
        ...
        # visualize_results(stem_img, hrtem_img)
        #
        # # Use the file paths as inputs to your functions
        # save_npy_file(config, stem_img, hrtem_img, file_paths['npy_file'])
        #
        ...
        # del config, model, coordinates, rotation_angle, stem_img, hrtem_img, params_dict
        # # del data_XY_scaled, data_XY_new, polygon_right, polygon_left, polygon_mid, annotation_params, mask
        # del file_paths
        #
...
#         print(f"Iteration {i}: Starting memory tracking")
#
#         # Check memory usage before creating objects
...
#
#         print(f"Iteration {i}: Memory usage after creation")
#         for stat in top_stats[:10]:  # Print top 10 memory allocations
#             print(stat)
#
#         print("\n\n")  # Adding space between iterations for clarity
#
#         # Explicitly delete large objects if they are not needed anymore
#         del stem_img, hrtem_img, params_dict
#         import gc
#         gc.collect()
#
